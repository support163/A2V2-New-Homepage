...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.a2v2.ai/healthcare-home' },
  openGraph: {
    ...
    url: 'https://www.a2v2.ai/healthcare-home',
    siteName: 'A2V2.ai',
    images: [
      {
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'Healthcare',
      item: 'https://www.a2v2.ai/healthcare-home',
    },
  ],
}
...
export default function HealthcareHomeLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
      {children}
      <script
