        ...
        <div className="flex flex-col md:flex-row items-center gap-12 md:gap-0">
          ...
          <div className="flex-1 text-center md:border-r md:border-gray-200">
            <div data-animate="" className="text-[48px] md:text-[56px] font-bold text-gray-900 leading-none">
              <AnimatedNumber target={100} format={(n) => `${Math.floor(n)}x`} />
            </div>
            <div className="text-sm text-gray-500 mt-3 uppercase tracking-wider">Faster lead response</div>
          </div>
          ...
          >
            ...
            <div className="text-sm text-gray-500 mt-3 uppercase tracking-wider">Lead engagement</div>
          </div>
          ...
          >
            ...
            <div className="text-sm text-gray-500 mt-3 uppercase tracking-wider">Extra staff needed</div>
          </div>
          ...
          >
            ...
            <div className="text-sm text-gray-500 mt-3 uppercase tracking-wider">To go live</div>
          </div>
