  ...
  return (
    <section className={`bg-white py-14 md:py-20 ${divider ? 'border-t border-gray-100' : ''}`}>
      <div className="mx-auto max-w-[1200px] px-6 md:px-12">
        ...
        >
          {/* Card — always first in DOM so mobile shows it on top; push right on desktop when reversed */}
          <div className={`relative min-h-[380px] rounded-xl overflow-hidden ${reverse ? 'md:order-last' : ''}`}>
            <div
          ...
          {/* Feature list accordion — push left on desktop when reversed */}
