      ...
      <div className="mx-auto max-w-[680px] px-6 text-center">
        ...
        >
          <a
            ...
            className="w-full sm:w-auto inline-flex justify-center items-center bg-primary text-white text-btn font-medium px-btn-x py-btn-y rounded-btn hover:bg-blue-700 transition-colors"
          >
            Try for Free
          </a>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-full sm:w-auto inline-flex justify-center items-center bg-background text-text-primary text-btn font-medium px-btn-x py-btn-y rounded-btn border border-text-primary hover:bg-gray-50 transition-colors"
          >
            See A Demo
          </a>
        </div>
