...
export default function CtaBanner({
  heading = 'Your audience is waiting to talk to you.',
  subtext = "Join the creators and professionals turning static traffic into active conversations. It's free to start and takes less than 2 minutes to train your first model.",
}: CtaBannerProps) {
  return (
