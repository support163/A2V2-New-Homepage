...
export default function LongevityFooter() {
      ...
      <div data-animate="" className="mx-auto max-w-[1280px] px-6 md:px-section-x py-8 md:py-section-y">
        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-[2fr_1fr_2fr]">
          ...
          <div>
            ...
            <p className="mt-4 text-sm leading-[22px] text-white/60 max-w-[280px]">
              The AI platform built for longevity clinics, functional medicine
              practices, and HRT clinics. Automate patient engagement, track
              protocol adherence, and increase retention &mdash; all HIPAA-compliant.
            </p>
          </div>
        ...
        <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
          <p className="text-sm text-white/40">&copy;2026 A2V2.ai All rights reserved</p>
