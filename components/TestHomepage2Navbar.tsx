...
import { ChevronDown, FormInput, Users, Bot, DollarSign, LayoutDashboard, BookOpen, FileText, Calendar, MessageSquare, Database, type LucideIcon } from 'lucide-react'
...
const FEATURES_ITEMS = [
  ...
  { title: 'Patient Messaging',  description: 'SMS reminders that get read',      href: '/features/patient-messaging',  Icon: MessageSquare  },
  { title: 'Pay For Access',     description: 'Monetize your expertise, safely',  href: '/features/pay-for-access',     Icon: DollarSign     },
  { title: 'EHR Data',           description: 'Bring your patient data together',  href: '/features/ehr-data',           Icon: Database       },
]
