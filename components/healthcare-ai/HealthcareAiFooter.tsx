...
export default function HealthcareAiFooter() {
        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-[2fr_1fr_2fr]">
          ...
          <div>
            ...
            <p className="mt-4 text-sm leading-[22px] text-white/60 max-w-[280px]">
              The healthcare AI platform built for clinical workflows.
              HIPAA-compliant patient engagement, protocol tracking, and
              retention &mdash; purpose-built for medicine.
            </p>
          </div>
