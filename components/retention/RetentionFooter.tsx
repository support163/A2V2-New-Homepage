...
export default function RetentionFooter() {
        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-[2fr_1fr_2fr]">
          ...
          <div>
            ...
            <p className="mt-4 text-sm leading-[22px] text-white/60 max-w-[280px]">
              AI-powered patient retention software for healthcare. Reduce
              drop-offs, automate engagement, and recover lost revenue &mdash;
              all HIPAA-compliant.
            </p>
          </div>
