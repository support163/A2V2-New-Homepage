...
export default function FunctionalMedicineFooter() {
        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-[2fr_1fr_2fr]">
          ...
          <div>
            ...
            <p className="mt-4 text-sm leading-[22px] text-white/60 max-w-[280px]">
              The AI platform built for functional medicine practices. Automate
              patient engagement, track protocol adherence, and increase
              retention &mdash; all HIPAA-compliant.
            </p>
          </div>
