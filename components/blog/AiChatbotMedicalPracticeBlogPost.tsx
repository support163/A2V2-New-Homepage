...
const ARTICLE_URL = 'https://www.a2v2.ai/blog/how-to-choose-ai-chatbot-medical-practice'
const ARTICLE_TITLE = 'How to Choose an AI Chatbot for Your Medical Practice'
...
function LightTable({ headers, rows }: { headers: string[]; rows: CellValue[][] }) {
  return (
                  ...
                  return (
                    <td
                      ...
                      style={{
                        ...
                        fontSize: 14,
                        color,
                        fontWeight: tint ? 500 : (ci === 0 ? 500 : 400),
                        fontFamily: I,
      ...
      <div style={{ paddingTop: 88 }}>
        <div className="mx-auto max-w-[720px] px-6 py-12 md:py-20">
          ...
          <article>
            ...
            <h3 style={h3Style}>Criterion 1: HIPAA Compliance (Non-Negotiable)</h3>
            <p style={bodyText}>
            ...
            <ActionBox>
              <p style={{ ...bodyText, marginBottom: 0 }}>
                <strong style={strongStyle}>1. Business Associate Agreement (BAA).</strong> A signed legal contract defining how the vendor handles PHI. No BAA means no PHI. Period. If a vendor tells you that you do not need a BAA because &quot;the chatbot does not store data&quot; or &quot;the data is anonymized,&quot; walk away.
              </p>
            </ActionBox>
            <ActionBox>
              <p style={{ ...bodyText, marginBottom: 0 }}>
                <strong style={strongStyle}>2. Encryption at rest and in transit.</strong> AES-256 for stored data, TLS 1.3 for data in motion. Ask for specifics. &quot;We use encryption&quot; is not a sufficient answer.
              </p>
            </ActionBox>
            <ActionBox>
              <p style={{ ...bodyText, marginBottom: 0 }}>
                <strong style={strongStyle}>3. Audit trails.</strong> Every interaction involving PHI must be logged with who, what, when, and from where. These logs must be retained and exportable for compliance audits.
              </p>
            </ActionBox>
            <ActionBox>
              <p style={{ ...bodyText, marginBottom: 0 }}>
                <strong style={strongStyle}>4. Access controls.</strong> Role-based permissions so your receptionist does not have the same data access as your physician.
              </p>
            </ActionBox>
            <ActionBox>
              <p style={{ ...bodyText, marginBottom: 0 }}>
                <strong style={strongStyle}>5. Data training restrictions.</strong> Your patient data must never be used to train the vendor&apos;s AI models. This must be guaranteed in writing, either in the BAA or a separate data processing agreement.
              </p>
            </ActionBox>
            <ActionBox>
              <p style={{ ...bodyText, marginBottom: 0 }}>
                <strong style={strongStyle}>6. U.S. data residency.</strong> For U.S. healthcare, patient data should be stored in U.S.-based data centers. If the vendor cannot tell you where your data is stored, that is a problem.
              </p>
            </ActionBox>
            ...
            <h3 style={h3Style}>Criterion 2: Clinical Awareness (Not Just Chat)</h3>
            <p style={bodyText}>
            ...
            <h3 style={h3Style}>Criterion 3: AI Model Quality and Selection</h3>
            <p style={bodyText}>
            ...
            <h3 style={h3Style}>Criterion 4: Integration with Your Existing Stack</h3>
            <p style={bodyText}>
            ...
            <h3 style={h3Style}>Criterion 5: Implementation Timeline and Complexity</h3>
            <p style={bodyText}>
            ...
            <h3 style={h3Style}>Criterion 6: Total Cost of Ownership</h3>
            <p style={bodyText}>
            ...
            <ActionBox>
              <p style={{ ...bodyText, marginBottom: 0 }}>
                <strong style={strongStyle}>1. Platform fee.</strong> Monthly subscription. Ranges from free tiers to $99+ per month for healthcare platforms, to $25K+ per year for enterprise CRMs. Make sure you understand what is included and what costs extra.
              </p>
            </ActionBox>
            <ActionBox>
              <p style={{ ...bodyText, marginBottom: 0 }}>
                <strong style={strongStyle}>2. Per-message or per-interaction fees.</strong> Some platforms charge per AI message on top of the subscription. At high patient volumes, this adds up quickly. Ask for the credit cost per message and model your monthly volume.
              </p>
            </ActionBox>
            <ActionBox>
              <p style={{ ...bodyText, marginBottom: 0 }}>
                <strong style={strongStyle}>3. Integration costs.</strong> Are EHR integrations included or do they require paid connectors or developer time?
              </p>
            </ActionBox>
            <ActionBox>
              <p style={{ ...bodyText, marginBottom: 0 }}>
                <strong style={strongStyle}>4. Training costs.</strong> How long does it take your team to learn the platform? Is onboarding included or billed separately?
              </p>
            </ActionBox>
            <ActionBox>
              <p style={{ ...bodyText, marginBottom: 0 }}>
                <strong style={strongStyle}>5. Switching costs.</strong> If the platform does not work out, can you export your data? Your conversation logs? Your patient contacts? Or are you locked in?
              </p>
            </ActionBox>
            <ActionBox>
              <p style={{ ...bodyText, marginBottom: 0 }}>
                <strong style={strongStyle}>6. Compliance costs.</strong> Is HIPAA compliance included or an add-on? Is the BAA included or does it require an enterprise contract?
              </p>
            </ActionBox>
            ...
            <p style={{ ...bodyText, fontWeight: 600, color: '#0F0E0D', marginBottom: '0.75rem' }}>
            ...
            <p style={{ ...bodyText, fontWeight: 600, color: '#0F0E0D', marginBottom: '0.75rem', marginTop: '1.5rem' }}>
            ...
            <div
              ...
              style={{ background: 'rgba(0,0,0,0.03)', border: '1px solid rgba(0,0,0,0.08)' }}
            >
              <p style={{ fontSize: 16, lineHeight: 1.6, color: '#1a1a1a', fontFamily: I, margin: 0 }}>
            ...
            <h3 style={h3Style}>Category 1: Scheduling and FAQ Bots</h3>
            <p style={bodyText}>
            ...
            <h3 style={h3Style}>Category 2: Patient Engagement Platforms</h3>
            <p style={bodyText}>
            ...
            <h3 style={h3Style}>Category 3: Enterprise Clinical AI</h3>
            <p style={bodyText}>
        ...
        <div style={{ background: '#FFFFFF', borderTop: '1px solid rgba(0,0,0,0.07)' }}>
          <div className="mx-auto max-w-[720px] px-6 py-20 md:py-28 text-center">
            ...
            >
              Find the right AI for your practice
            </h2>
            <p
              style={{
                fontSize: 17,
            ...
            >
              Book a demo and we will show you how A2V2 Medical Agents work for your specific clinic.
            </p>
