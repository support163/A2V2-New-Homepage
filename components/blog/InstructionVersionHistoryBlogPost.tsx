...
const CURRENT_HREF = '/blog/instruction-version-history'
const ARTICLE_URL = 'https://www.a2v2.ai/blog/instruction-version-history'
const ARTICLE_TITLE = 'Full version history for your agent\'s instructions'

const relatedPosts = getRelatedPosts(CURRENT_HREF, 3)

const faqItems = [
  {
    q: 'What does version history track?',
    a: 'It keeps a complete history of your agent\'s instructions, including both major and minor changes, so you have a full record of how your instructions have evolved.',
  },
  {
    q: 'How do I know which instruction version produced a response?',
    a: 'The exact instruction version is recorded on every response your agent gives, so you can always see which version was in effect for any given answer.',
  },
  {
    q: 'Can I roll back to a previous version?',
    a: 'Yes. Because every version is saved, every change is reversible. You can experiment freely and roll back if a change does not work the way you hoped.',
  },
  {
    q: 'Where do I find instruction version history?',
    a: 'Go to Agents, select your agent, then Expertise, then Instructions.',
  },
]
...
/* ── Main component ── */
export default function InstructionVersionHistoryBlogPost() {
  return (
      ...
      <div style={{ paddingTop: 88 }}>
        <div className="mx-auto max-w-[720px] px-6 py-12 md:py-20">
          ...
          <header className="mb-10">
            ...
            >
              Full version history for your agent&apos;s instructions
            </h1>
            ...
            >
              Your agent&apos;s instructions now carry complete version history, and the exact version is recorded on every response. Experiment freely, track every change, and roll back anytime.
            </p>
          ...
          <div className="w-full mb-12">
            <Image
              src="/images/instruction-version-history.png"
              alt="Instruction version history in A2V2"
              width={1280}
              height={720}
              ...
              onError={(e) => {
                ...
                img.src = '/images/crm-automations.png'
              }}
            />
          </div>
          ...
          <article>
            <p style={bodyText}>
              Refining how your agent responds should feel safe, not risky. Now it is. Your agent&apos;s instructions carry a complete version history, so you can change things freely and always know exactly what was in effect.
            </p>
            <p style={bodyText}>
              We are rolling out full version history for agent instructions, with the exact version recorded on every response.
            </p>

            <h2 style={h2Style}>Every version, tracked</h2>
            <p style={bodyText}>
              Your agent&apos;s instructions now keep a complete version history, both major and minor changes. Every time you update how your agent behaves, that version is saved, so you have a full record of how your instructions have evolved.
            </p>

            <ul style={{ paddingLeft: 0, listStyle: 'none', marginBottom: '1.5rem' }}>
              {[
                'Complete version history for major and minor changes',
                'A full record of how your instructions evolved over time',
                'Clarity on exactly what changed, and when',
              ].map((item, i) => (
                <li
                  key={i}
                  style={{
            ...
            <h2 style={h2Style}>Recorded on every response</h2>
            <p style={bodyText}>
              The exact instruction version is recorded on every response your agent gives. If you ever need to understand why your agent answered a certain way, you can see precisely which version of your instructions was in effect at that moment.
            </p>

            <NoteBox>
              This closes the loop between what you changed and what your agent did. Every response is tied to a specific version, so nothing is a mystery.
            </NoteBox>

            <h2 style={h2Style}>Experiment freely</h2>
            <p style={bodyText}>
              Because every version is saved, you can try new instructions without fear. If a change does not work the way you hoped, you can roll back. Every change is reversible.
            </p>
            ...
            <ul style={{ paddingLeft: 0, listStyle: 'none', marginBottom: '1.5rem' }}>
              {[
                'Refine your agent\'s behavior with confidence',
                'Understand exactly which instructions produced any response',
                'Roll back changes anytime, so experimenting carries no risk',
                'Keep a clear, trackable record of your agent\'s evolution',
              ].map((item, i) => (
                <li
                  key={i}
                  style={{
            ...
            <p style={bodyText}>
              It is live now in your agent&apos;s expertise settings.
            </p>
            ...
            >
              Agents &rarr; your agent &rarr; Expertise &rarr; Instructions
            </div>
        ...
        <div style={{ background: '#FFFFFF', borderTop: '1px solid rgba(0,0,0,0.07)' }}>
          <div className="mx-auto max-w-[720px] px-6 py-20 md:py-28 text-center">
            ...
            >
              Book a demo and we will show you instruction version history and everything else A2V2 can do for your clinic.
            </p>
