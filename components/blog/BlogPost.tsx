  ...
  return (
    <>
      ...
      <div className="bg-background">
        ...
        {/* ── CTA Banner ── */}
        <CtaBanner
          heading="Find Out What Patient Drop-Off Is Really Costing Your Clinic"
          subtext="Book a free 30-minute Patient Retention Audit. No sales pitch—just data, insights, and a custom plan for your practice."
        />
