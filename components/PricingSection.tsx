...
const plans: Plan[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Public Access', included: true },
      { text: 'Access to Premium models', included: true },
      { text: '3 team members included, additional members can be added by purchasing add-ons.', included: true },
    ],
    cta: 'Upgrade',
    ctaStyle: 'filled',
    badge: 'Recommended',
  },
  {
    ...
    features: [
      ...
      { text: 'Public Access', included: true },
      { text: 'Access to Premium models', included: true },
      { text: '5 team members included, additional members can be added by purchasing add-ons.', included: true },
    ],
    cta: 'Upgrade',
    ctaStyle: 'outline',
  },
